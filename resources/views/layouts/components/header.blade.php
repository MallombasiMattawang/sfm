<header id="sportsmagazine-header" class="sportsmagazine-header-one">
            ...
            <div class="row">
                ...
                <aside class="col-md-8">
                    <ul class="sportsmagazine-user-section">
                        ...
                        <li><i class="fa fa-shopping-cart"></i> <a href="#"
                                class="sportsmagazine-open-cart">Cart (0)</a>
                            <div class="sportsmagazine-cart-box">
                                <h2>You have 2 items in the cart</h2>
                                <ul>
                                    <li>
                                        <figure>
                                            <a href="checkout.html"><img
                                                    src="/assets/extra-images/cartbox-1.png"
                                                    alt=""></a>
                                        </figure>
                                        <div class="sportsmagazine-cartbox-text">
                                            <h6><a href="checkout.html">Key Management Model The 60+ Models</a>
                                            </h6>
                                            <div class="sportsmagazine-rating"><span
                                                    class="sportsmagazine-rating-box"
                                                    style="width:80%"></span></div>
                                            <span
                                                class="sportsmagazine-cartbox-price sportsmagazine-color">$35.99
                                                <small>$43.00</small></span>
                                        </div>
                                    </li>
                                    <li>
                                        <figure>
                                            <a href="checkout.html"><img
                                                    src="/assets/extra-images/cartbox-2.png"
                                                    alt=""></a>
                                        </figure>
                                        <div class="sportsmagazine-cartbox-text">
                                            <h6><a href="checkout.html">Pyramid Principle: Logic Writing &amp;
                                                    Thinking</a></h6>
                                            <div class="sportsmagazine-rating"><span
                                                    class="sportsmagazine-rating-box"
                                                    style="width:100%"></span></div>
                                            <span
                                                class="sportsmagazine-cartbox-price sportsmagazine-color">$21.00</span>
                                        </div>
                                    </li>
                                </ul>
                                <h5>Subtotal <span class="sportsmagazine-color">$1343</span></h5>
                                <div class="sportsmagazine-cart-link"><a href="checkout.html"
    ...
    <div class="sportsmagazine-main-header">
        <div class="container">
            <div class="row">
                <aside class="col-md-2"><a href="/" class="sportsmagazine-logo"><img
                            src="/assets/images/logo_sfm.png" alt="logo-sfm" width="50%"
                            style="margin-top: -20px"></a></aside>
                <div class="col-md-10">
                                            ...
                                            <li class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <ul class="sportsmagazine-megalist">
                                                        ...
                                                        <li><a href="fixture-wls.html">Fixture List W/L/S</a>
                                                        </li>
                                                        <li><a href="fixture-wrs.html">Fixture List W/R/S</a>
                                                        </li>
                                                        <li><a href="fixtures-dark1.html">Fixtures Classic</a>
                                                        </li>
                                                        <li><a href="fixtures-dark2.html">Fixtures Modren</a>
                                                        </li>
                                                        <li><a href="fixture-detail.html">Fixture Detail</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <ul class="sportsmagazine-megalist">
                                                        ...
                                                        <li><a href="gallery-wls.html">Gallery Classic
                                                                W/L/S</a></li>
                                                        <li><a href="gallery-wrs.html">Gallery Classic
                                                                W/R/S</a></li>
                                                        <li><a href="gallery-modren.html">Gallery Modren</a>
                                                        </li>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <ul class="sportsmagazine-megalist">
                                                        ...
                                                        <li><a href="search-result.html">No Search Result</a>
                                                        </li>
                                                ...
                                                <div class="col-md-6">
                                                    <a href="#" class="sportsmagazine-thumbnail">
                                                        <img src="/assets/extra-images/megamenu-frame.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                            </li>
                                        ...
                                        <ul class="sportsmagazine-dropdown-menu">
                                            <li><a href="player-grid.html">Player Grid</a>
                                                <ul class="sportsmagazine-dropdown-menu">
                                                    ...
                                                    <li><a href="player-grid-wls.html">Player Grid W/L/S</a>
                                                    </li>
                                                    <li><a href="player-grid-wrs.html">Player Grid W/R/S</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="player-modren.html">Player Modren</a>
                                                <ul class="sportsmagazine-dropdown-menu">
                                                    <li><a href="player-modren.html">Player Modren W/O/S</a>
                                                    </li>
                                                    <li><a href="player-modren-wls.html">Player Modren
                                                            W/L/S</a></li>
                                                    <li><a href="player-modren-wrs.html">Player Modren
                                                            W/R/S</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a href="player-detail.html">Player Detail</a>
                                                <ul class="sportsmagazine-dropdown-menu">
                                                    <li><a href="player-detail.html">Player Detail W/L/S</a>
                                                    </li>
                                                    <li><a href="player-detail-wls.html">Player Detail
                                                            W/R/S</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="sportsmagazine-dropdown-menu">
                                            ...
                                            <li><a href="blog-modren.html">Blog Modren</a>
                                                <ul class="sportsmagazine-dropdown-menu">
                                                    ...
                                                    <li><a href="blog-modren-wls.html">Blog Modren W/L/S</a>
                                                    </li>
                                                    <li><a href="blog-modren-wrs.html">Blog Modren W/R/S</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="blog-detail.html">Blog Detail</a>
                                                <ul class="sportsmagazine-dropdown-menu">
                                                    ...
                                                    <li><a href="blog-detail-wls.html">Blog Detail W/L/S</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="sportsmagazine-dropdown-menu">
                                            ...
                                            <li><a href="shop-detail.html">Shop Detail</a>
                                                <ul class="sportsmagazine-dropdown-menu">
                                                    ...
                                                    <li><a href="shop-detail-wls.html">Shop Detail W/L/S</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="sportsmagazine-megamenu">
                                            <li class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="sportsmagazine-mega-text">
                                                        <p>Your work is going to fill a large part of your life,
                                                            ...
                                                            great work is to love.</p>
                                                        <p>If you haven't found it yet, keep looking. Don't
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <a href="#" class="sportsmagazine-thumbnail">
                                                        <img src="/assets/extra-images/mega-menuadd.jpg"
                                                            alt="" />
                                                    </a>
                                                </div>
                                            </li>
