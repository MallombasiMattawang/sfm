...
<head>
    ...
    <meta name="description" content="Deskripsi singkat tentang situs web Anda.">
    <meta name="keywords" content="kata kunci, kata kunci lain, kata kunci lainnya">
    <meta name="author" content="Nama Anda">
    <title>Sahabat Football Makassar</title>

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Judul Halaman Anda">
    <meta property="og:description" content="Deskripsi singkat tentang situs web Anda.">
    <meta property="og:image" content="url_gambar">
    <meta property="og:url" content="URL_halaman_anda">
    <meta property="og:type" content="website">

    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:title" content="Judul Halaman Anda">
    <meta name="twitter:description" content="Deskripsi singkat tentang situs web Anda.">
    <meta name="twitter:image" content="url_gambar">
    ...
    <!-- JavaScript Eksternal (Opsional) -->
    <script src="script.js" defer></script>

    <!-- Meta untuk WhatsApp -->
    <meta property="og:site_name" content="Judul Situs Anda">
    <meta property="og:title" content="Judul Halaman Anda">
    <meta property="og:description" content="Deskripsi singkat tentang situs web Anda.">
    <meta property="og:image" content="url_gambar">
    <meta property="og:url" content="URL_halaman_anda">
    ...
    <div class="sportsmagazine-main-wrapper">
        ...
        <div class="sportsmagazine-banner">
            ...
            <div class="sportsmagazine-banner-one">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="sportsmagazine-banner-wrap">
                                        <h1><span>Kami adalah</span>  <strong
                                                class="sportsmagazine-color">Sahabat Football Makassar</strong> <span>SFM-CLUB</span>
                                        </h1>

                                    </div>
                                    <div class="sportsmagazine-banner-thumb"> <img
                                            src="/assets/extra-images/3.png" alt=""> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sportsmagazine-banner-one-layer">
                    <img src="/assets/extra-images/2.png" alt="">
                    <span class="sportsmagazine-banner-pattren"></span>
                    <div class="sportsmagazine-banner-caption">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="sportsmagazine-banner-thumb"> <img
                                            src="/assets/extra-images/6.png" alt="" width="60%"> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="sportsmagazine-featured-slider">
                                <div class="sportsmagazine-featured-slider-layer">
                                    <img src="/assets/extra-images/featured-slider-1.jpg" alt="">
                                ...
                                <div class="sportsmagazine-featured-slider-layer">
                                    <img src="/assets/extra-images/featured-slider-2.jpg" alt="">
                                    <span class="sportsmagazine-black-transparent"></span>
                                    <div class="sportsmagazine-featured-caption">
                                        <h2>Fusce at molestie elit, sit amet Curabitur in tellus non risu illa vitae non
                                            nunc</h2>
                            ...
                            <div class="sportsmagazine-match-result">
                                ...
                                <ul>
                                    <li>
                                        <img src="/assets/extra-images/latest-result-logo-1.png" alt="">
                                    ...
                                    <li>
                                        <img src="/assets/extra-images/latest-result-logo-2.png" alt="">
                            ...
                            <div class="sportsmagazine-blog sportsmagazine-blog-grid">
                                <ul class="row">
                                    <li class="col-md-6">
                                        <figure>
                                            <a href="blog-detail.html"><img
                                                    src="/assets/extra-images/latest-blog-1.jpg" alt=""></a>
                                            <figcaption>
                                        ...
                                        <section>
                                            <h2><a href="blog-detail.html">The new eco friendly stadium won a Leafy
                                                    Award in 2016</a></h2>
                                            <p>Lorem ipsum dolor sit amet, consecttur adipis elit. Vestibulum a nunc
                                                dui. Curabitr dignissi luctus nisi id euismod. feugiat eros.
                                                Pellentesque tempus tortor.</p>
                                        </section>
                                        <div class="sportsmagazine-blog-grid-options">
                                            <a href="blog-detail.html" class="sportsmagazine-blog-grid-thumb"><img
                                                    src="/assets/extra-images/blog-thumb-1.jpg" alt=""> Julia
                                                Martyn</a>
                                            <ul>
                                    ...
                                    <li class="col-md-6 sportsmagazine-the-league">
                                        <figure>
                                            <a href="blog-detail.html"><img
                                                    src="/assets/extra-images/latest-blog-2.jpg" alt=""></a>
                                            <figcaption>
                                        ...
                                        <section>
                                            <h2><a href="blog-detail.html">Michael Bryan was chosen as best player with
                                                    45 points</a></h2>
                                            <p>Lorem ipsum dolor sit amet, consecttur adipis elit. Vestibulum a nunc
                                                dui. Curabitr dignissi luctus nisi id euismod. feugiat eros.
                                                Pellentesque tempus tortor.</p>
                                    ...
                                    <div class="sportsmagazine-blog sportsmagazine-blog-grid">
                                        <ul class="row">
                                            <li class="col-md-12 sportsmagazine-the-team">
                                                <figure>
                                                    <a href="blog-detail.html"><img
                                                            src="/assets/extra-images/latest-blog-3.jpg"
                                                            alt=""></a>
                                                    <figcaption>
                                                ...
                                                <section>
                                                    <h2><a href="blog-detail.html">The vicotory againts The Shark
                                                            brings us close to the Final</a></h2>
                                                ...
                                                <div class="sportsmagazine-blog-grid-options">
                                                    <a href="blog-detail.html"
                                                        class="sportsmagazine-blog-grid-thumb"><img
                                                            src="/assets/extra-images/blog-thumb-1.jpg"
                                                            alt=""> Julia Martyn</a>
                                                    <ul>
                                                        <li><i class="fa fa-thumbs-o-up"></i> <a
                                                                href="404.html">320</a></li>
                                                        <li><i class="fa fa-eye"></i> <a href="404.html">840</a></li>
                                        ...
                                        <ul class="row">
                                            <li class="col-md-12">
                                                <div class="sportsmagazine-blog-list-wrap">
                                                    <span>The Team</span>
                                                    <h6><a href="blog-detail.html">The victry againts The Shark bring
                                                            us closer to the Final</a></h6>
                                            ...
                                            <li class="col-md-12 playoffs">
                                                <div class="sportsmagazine-blog-list-wrap">
                                                    <span>Playoffs</span>
                                                    <h6><a href="blog-detail.html">The new eco friendly stadium won a
                            ...
                            <figure class="sportsmagazine-add-banner">
                                <img src="/assets/extra-images/add-thumb-1.jpg" alt="">
                                ...
                                <figcaption>
                                    <div class="sportsmagazine-addbanner-caption">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Utac malesuada ante.
                                            Curabitur lacinia.</p>
                                        <a href="404.html" class="sportsmagazine-banner-btn">Read More
                                            <span></span></a>
                                    </div>
                                </figcaption>
                            </figure>
                            ...
                            <div class="sportsmagazine-player-slider">
                                ...
                                <div class="sportsmagazine-player-slider-image">
                                    <div class="sportsmagazine-player-image-layer">
                                        <img src="/assets/extra-images/player-slider-image-1.png" alt="">
                                    ...
                                    <div class="sportsmagazine-player-image-layer">
                                        <img src="/assets/extra-images/player-slider-image-2.png" alt="">
                                        <div class="sportsmagazine-player-slider-caption">
                                            <span>38</span>
                                            <section>
                                    ...
                                    <div class="sportsmagazine-player-image-layer">
                                        <img src="/assets/extra-images/player-slider-image-3.png" alt="">
                                        <div class="sportsmagazine-player-slider-caption">
                                            <span>97</span>
                                            <section>
                                                <h6><a href="fixture-detail.html">Micheal Darren</a></h6>
                            ...
                            <div class="sportsmagazine-gallery sportsmagazine-fixture-gallery">
                                <ul>
                                    <li>
                                        <figure>
                                            <a data-fancybox-group="group" href="extra-images/gallery-modren-img1.jpg"
                                                class="fancybox"><img
                                                    src="/assets/extra-images/gallery-modren-img1.jpg"
                                                    alt=""><i class="icon-signs23"></i></a>
                                            <span>12 Photos</span>
                                            <figcaption>
                                    ...
                                    <li>
                                        <figure>
                                            <a data-fancybox-group="group" href="extra-images/gallery-modren-img2.jpg"
                                                class="fancybox"><img
                                                    src="/assets/extra-images/gallery-modren-img2.jpg"
                                                    alt=""><i class="icon-signs23"></i></a>
                                            <span>11 Photos</span>
                                            <figcaption>
                                                <h6><a href="#">The Champion Final will be played</a></h6>
                                    ...
                                    <li>
                                        <figure>
                                            <a data-fancybox-group="group" href="extra-images/gallery-modren-img3.jpg"
                                                class="fancybox"><img
                                                    src="/assets/extra-images/gallery-modren-img3.jpg"
                                                    alt=""><i class="icon-signs23"></i></a>
                                            <span>7 Photos</span>
                                            <figcaption>
                                                <h6><a href="#">The Champion Final will be played</a></h6>
                                    ...
                                    <li>
                                        <figure>
                                            <a data-fancybox-group="group" href="extra-images/gallery-modren-img4.jpg"
                                                class="fancybox"><img
                                                    src="/assets/extra-images/gallery-modren-img4.jpg"
                                                    alt=""><i class="icon-signs23"></i></a>
                                            <span>4 Photos</span>
                                            <figcaption>
                                                <h6><a href="#">The Champion Final will be played</a></h6>
                                    ...
                                    <li>
                                        <figure>
                                            <a data-fancybox-group="group" href="extra-images/gallery-modren-img5.jpg"
                                                class="fancybox"><img
                                                    src="/assets/extra-images/gallery-modren-img5.jpg"
                                                    alt=""><i class="icon-signs23"></i></a>
                                            <span>13 Photos</span>
                                            <figcaption>
                                                <h6><a href="#">The Champion Final will be played</a></h6>
                                    ...
                                    <li>
                                        <figure>
                                            <a data-fancybox-group="group" href="extra-images/gallery-modren-img6.jpg"
                                                class="fancybox"><img
                                                    src="/assets/extra-images/gallery-modren-img6.jpg"
                                                    alt=""><i class="icon-signs23"></i></a>
                                            <span>6 Photos</span>
                                            <figcaption>
                                                <h6><a href="#">The Champion Final will be played</a></h6>
                        ...
                        <aside class="col-md-4">
                            ...
                            <div class="widget widget_team_ranking">
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>1</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-1.png" alt="">
                                            <div class="ranking-logo"><span>L.A Pirates</span> <small>Bebop
                                                    Institute</small> </div>
                                        </li>
                                        <li>08</li>
                                        <li>08</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>2</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-2.png" alt="">
                                            <div class="ranking-logo"><span>Ocean Kings</span> <small>Icarus
                                                    College</small> </div>
                                        </li>
                                        <li>08</li>
                                        <li>07</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>3</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-3.png" alt="">
                                            <div class="ranking-logo"><span>Red Wings</span> <small>Marine
                                                    College</small> </div>
                                        </li>
                                        <li>07</li>
                                        <li>07</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>4</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-4.png" alt="">
                                            <div class="ranking-logo"><span>Lucky Clovers</span> <small>Elric Bros
                                                    School</small> </div>
                                        </li>
                                        <li>07</li>
                                        <li>06</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>5</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-5.png" alt="">
                                            <div class="ranking-logo"><span>Draconians</span> <small>Atlantic
                                                    School</small> </div>
                                        </li>
                                        <li>06</li>
                                        <li>05</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>6</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-6.png" alt="">
                                            <div class="ranking-logo"><span>Bloody Wave</span> <small>Marine
                                                    College</small> </div>
                                        </li>
                                        <li>06</li>
                                        <li>04</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>7</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-7.png" alt="">
                                            <div class="ranking-logo"><span>Ocean Kings</span> <small>St. Patrick’s
                                                    Institute</small> </div>
                                        </li>
                                        <li>06</li>
                                        <li>04</li>
                                ...
                                <div class="ranking-content-table">
                                    <ul class="ranking-content-row">
                                        <li>8</li>
                                        <li> <img src="/assets/extra-images/ranking-widget-flag-2.png" alt="">
                                            <div class="ranking-logo"><span>Sharks</span> <small>Icarus College</small>
                                            </div>
                                        </li>
                                        <li>06</li>
                                        <li>02</li>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="popular_news_text">
                                            ...
                                            <a href="blog-detail.html">Basketball Stadium will a max capacity for 5000
                                                fans</a>
                                    ...
                                    <li class="widget-injuries">
                                        ...
                                        <div class="popular_news_text">
                                            ...
                                            <a href="blog-detail.html">The Clovers defense must reinvent itself
                                                without</a>
                                            <time datetime="2008-02-14 20:00">December 21, 2017</time>
                                        </div>
                                    </li>
                                    <li class="widget-theleague">
                                        ...
                                        <div class="popular_news_text">
                                            ...
                                            <a href="blog-detail.html">Take look to the brand new helmets for next
                                                season</a>
                                            <time datetime="2008-02-14 20:00">December 21, 2017</time>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="popular_news_text">
                                            <small>The Team</small>
                                            <a href="blog-detail.html">The Basketball women division started
                                                training</a>
                                            <time datetime="2008-02-14 20:00">December 21, 2017</time>
                                        </div>
                                    </li>
                            ...
                            <div class="widget widget_trending_news">
                                <div class="sportsmagazine-fancy-title">
                                    <h2>Top Trending News</h2>
                                </div>
                                <!-- Nav tabs -->
                                <ul class="nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#home" aria-controls="home"
                                            role="tab" data-toggle="tab">Newset</a></li>
                                    <li role="presentation"><a href="#profile" aria-controls="profile"
                                            role="tab" data-toggle="tab">Most Commented</a></li>
                                    <li role="presentation"><a href="#messages" aria-controls="messages"
                                            role="tab" data-toggle="tab">Populer</a></li>
                                </ul>
                                <!-- Tab panes -->
                                        ...
                                        <div class="widget_popular_news">
                                            <ul>
                                                <li>
                                                    <div class="popular_news_text">
                                                        <small>The Team</small>
                                                        <a href="blog-detail.html">Basketball Stadium will a max
                                                            capacity for 5000 fans</a>
                                                        <time datetime="2008-02-14 20:00">December 21, 2017</time>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                                                            ac malesuada ante. Curabitur lacinia diam tempus.</p>
                                                    </div>
                                                </li>
                                                <li class="widget-injuries">
                                                    <div class="popular_news_text">
                            ...
                            <div class="widget widget_next_match">
                                ...
                                <ul>
                                    <li>
                                        <img src="/assets/extra-images/widget-next-match-logo-1.png" alt="">
                                    ...
                                    <li>
                                        <img src="/assets/extra-images/widget-next-match-logo-2.png" alt="">
                            ...
                            <div class="widget widget_newsletter">
                                ...
                                <form>
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ac malesuada ante.
                                    </p>
                                    ...
                                    <label class="widget_newsletter_btn"><input type="submit"
                            ...
                            <div class="widget widget_add">
                                <img src="/assets/extra-images/add.jpg" alt="">
                            </div>
                            <!--// Widget Add \\-->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <aside class="col-md-4 widget widget_contact_info">
                            <a href="index-2.html" class="footer-logo"><img src="/assets/images/logo-1.png"
                                    alt=""></a>
                            ...
                            <ul class="sportsmagazine-info-list">
                                <li><i class="fa fa-map-marker"></i> <span>9907 Salford road, east London Uk
                                        2807</span></li>
                        ...
                        <aside class="col-md-4 widget widget_gallery">
                            ...
                            <ul>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-1.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-2.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-3.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-4.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-5.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-6.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-7.jpg"
                                            alt=""></a></li>
                                <li><a data-fancybox-group="group" href="extra-images/widget-gallery-1.jpg"
                                        class="fancybox"><img src="/assets/extra-images/widget-gallery-8.jpg"
                                            alt=""></a></li>
                            </ul>
                        </aside>
                        <!--// Widget Gallery \\-->
        ...
        <div class="modal-dialog" role="document">
            <div class="sportsmagazine-login-box">
                ...
                <ul class="login-network">
                    ...
                    <li class="sportsmagazine-twitter"><a href="#"><i class="fa fa-twitter-square"></i>
                            Twitter</a></li>
